    ...
    "div",
    {
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsx(
        "span",
        {
          ...
          children: "TACTICAL STAGE — LOADING"
        }
      )
    }
  );
...
const useSubtitleStore = create((set) => ({
  text: null,
  show: (text, durationMs = 4e3) => {
    set({ text });
    setTimeout(() => set({ text: null }), durationMs);
  },
  clear: () => set({ text: null }),
  showSubtitle: (text, durationMs = 4e3) => {
    set({ text });
    setTimeout(() => set({ text: null }), durationMs);
  },
...
const DIALOGUE_LINES = [
  ...
  { at: 18, text: "Navigation systems partially restored." },
...
const HUD_LINES = [
  { at: 14, label: "AEGIS CORE", color: "#00ccff" },
...
function CinematicIntro() {
  ...
  const [activeDialogue, setActiveDialogue] = reactExports.useState(null);
  const [visibleHudLines, setVisibleHudLines] = reactExports.useState(
    /* @__PURE__ */ new Set()
  );
  const startRef = reactExports.useRef(null);
  const rafRef = reactExports.useRef(0);
  const completedRef = reactExports.useRef(false);
  const spokenLinesRef = reactExports.useRef(/* @__PURE__ */ new Set());
  const premiumSpokenRef = reactExports.useRef(false);
  reactExports.useEffect(() => {
    const t = setTimeout(() => {
  ...
  reactExports.useEffect(() => {
    const tick = (ts) => {
      ...
      const t = (ts - startRef.current) / 1e3;
      setElapsed(t);
    ...
    rafRef.current = requestAnimationFrame(tick);
    const skipTimer = setTimeout(() => setShowSkip(true), 1e3);
    return () => {
  ...
  const earthScale = 0.35 + Math.min(0.4, Math.max(0, (elapsed - 7) / 18) * 0.4);
      ...
      children: [
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "svg",
                {
                  ...
                  children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("title", { children: "Deep space star field" }),
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "div",
                {
                  style: {
                    position: "absolute",
                    inset: 0,
                    background: "radial-gradient(ellipse 60% 40% at 70% 30%, rgba(0,30,80,0.35) 0%, transparent 70%),radial-gradient(ellipse 40% 60% at 30% 70%, rgba(30,0,60,0.25) 0%, transparent 70%)"
                  }
                }
              )
            ]
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            style: {
              ...
              height: "80%",
              borderRadius: "50%",
              background: "radial-gradient(ellipse at 50% 80%, rgba(0,120,255,0.18) 0%, rgba(0,60,180,0.08) 40%, transparent 65%)",
              opacity: earthGlow,
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            style: {
              ...
              borderRadius: "50%",
              background: "radial-gradient(circle at 35% 32%, #1a5fad 0%, #0d3d80 25%, #091f4a 55%, #030d20 100%)",
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "div",
                {
                  style: {
                    ...
                    inset: 0,
                    borderRadius: "50%",
                    background: "radial-gradient(ellipse 80% 30% at 40% 45%, rgba(180,210,255,0.12) 0%, transparent 60%),radial-gradient(ellipse 60% 20% at 60% 60%, rgba(180,210,255,0.08) 0%, transparent 50%)"
                  }
                }
              ),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "div",
                {
                  style: {
                    ...
                    boxShadow: "0 0 40px 12px rgba(80,160,255,0.22), inset 0 0 30px rgba(80,180,255,0.15)",
                    pointerEvents: "none"
                  }
                }
              )
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            ...
            children: HUD_LINES.map((line) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "div",
              {
                style: {
                  display: "flex",
                  ...
                  transform: visibleHudLines.has(line.label) ? "translateX(0)" : "translateX(-12px)",
          ...
          "div",
          {
            ...
            children: /* @__PURE__ */ jsxRuntimeExports.jsx(
              "div",
              {
                ...
                children: "A.E.G.I.S. — TACTICAL COMMAND INTERFACE"
              }
            )
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            ...
            children: [
              activeDialogue && /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "div",
                {
                  style: {
                    fontFamily: "monospace",
            ...
            children: /* @__PURE__ */ jsxRuntimeExports.jsx(
              "div",
              {
                style: {
                  ...
                  background: "linear-gradient(90deg, rgba(0,150,255,0.6), rgba(0,255,200,0.8))",
        ...
        showSkip && /* @__PURE__ */ jsxRuntimeExports.jsx(
          "button",
          {
            type: "button",
            onClick: handleSkip,
            ...
            onMouseEnter: (e) => {
              e.currentTarget.style.color = "rgba(0,230,255,0.9)";
              e.currentTarget.style.borderColor = "rgba(0,200,255,0.5)";
            },
            onMouseLeave: (e) => {
              e.currentTarget.style.color = "rgba(0,180,255,0.65)";
              e.currentTarget.style.borderColor = "rgba(0,160,220,0.25)";
            },
            children: "SKIP INTRO"
          }
        ),
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        ...
        children: [
          introPlaying && /* @__PURE__ */ jsxRuntimeExports.jsx(CinematicIntro, {}),
          !introPlaying && introComplete && /* @__PURE__ */ jsxRuntimeExports.jsx(TacticalStage, {})
        ]
      }
    )
  ] });
